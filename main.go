...
import ( "fmt"
	...
	"time"
	"flag"
	requests "serviceheroes/tickets/requests"
...
func main() {
	...
	user := flag.String("username", os.Getenv("USERNAME"), "Username")
	...
	assignee := flag.String("assignee", os.Getenv("USERNAME"), "Assignee to view or create ticket for")
